...
for i = 1:target_num
    ...
    target_temp = []
    for ii = 1:trial_num
        Familiarisation_Target_num_temp = Familiarisation_Target{i}(ii).FILE_NAME;
        Familiarisation_Target_num_temp = Familiarisation_Target_num_temp(4:5);
        Familiarisation_Target_num_temp = str2num(Familiarisation_Target_num_temp);
        target_temp = [target_temp; Familiarisation_Target_num_temp];
    end
    ...
    trial_temp = []
    for ii = 1:trial_num
        Familiarisation_Trial_idx_temp = Familiarisation_Target{i}(ii).TRIAL(1).TRIAL_NUM
        trial_temp = [trial_temp; Familiarisation_Trial_idx_temp];
    end
